...
export function HangerIcon(props) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M12 7v2l8.5 5.2c.9.6.5 2-.6 2H4.1c-1.1 0-1.5-1.4-.6-2L12 9" />
    </svg>
  )
}
...
export function CameraIcon(props) {
  return (
    <svg {...base} {...props}>
      <path d="M3 8a2 2 0 0 1 2-2h2l1.2-2h7.6L19 6h0a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8Z" />
